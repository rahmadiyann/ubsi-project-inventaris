...
export default function OperatorDetail({ params }: { params: { id: string } }) {
      ...
      if (params.id) {
        try {
          const response = await fetch(
            `/api/prisma?type=operator&id=${params.id}`
          );
  ...
  if (loading) return <OperatorDetailSkeleton />;
  if (error) return <div className="text-red-500">{error}</div>;
  if (!operator) return <div className="text-gray-500">Operator not found</div>;
      ...
      <Card className="w-full max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>{operator.name}</AlertDialogTitle>
                    <AlertDialogDescription>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      the operator from the database.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel>Cancel</AlertDialogCancel>
        ...
        <CardContent className="pt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <InfoItem icon={Mail} title="Email" value={operator.email} />
          </div>
        </CardContent>
